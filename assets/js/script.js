var baseURL = "https://beingcodepoet.com/youtube-counter";
...
if (window.location.hostname != "localhost" && 1) {
  ...
  if (location.hostname.indexOf("beingcodepoet.com") == -1) window.location.replace(baseURL + location.hash);
...
update.share = function(a) {
  ...
  var facebook = "https://www.facebook.com/" + sharableLink + "&redirect_uri=" + encodeURIComponent(baseURL + "assets/close.html");
